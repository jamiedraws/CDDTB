...
<link rel="preload" href="/css/17.0000/shell.css<%= v %>" as="style">
<link rel="stylesheet" href="/css/17.0000/shell.css<%= v %>">
...
<% if (DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/17.0000/page.css<%= v %>" as="style">
    <link rel="stylesheet" href="/css/17.0000/page.css<%= v %>">  

    <% if (DtmContext.PageCode == "Index") { %>
        <link rel="preload" href="/css/17.0000/index.css<%= v %>" as="style">
        <link rel="stylesheet" href="/css/17.0000/index.css<%= v %>">
    <% } %>


    <% if (DtmContext.PageCode == "How-To-Use") { %>
        <link rel="preload" href="/css/17.0000/how-to-use.css<%= v %>" as="style">
        <link rel="stylesheet" href="/css/17.0000/how-to-use.css<%= v %>">
    <% } %>

    <% if (DtmContext.PageCode == "FAQ") { %>
        <link rel="preload" href="/css/17.0000/faq.css<%= v %>" as="style">
        <link rel="stylesheet" href="/css/17.0000/faq.css<%= v %>">
    <% } %>

    <script defer src="/js/17.0000/app.js<%= v %>"></script>
...
<% if (!DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/17.0000/dtm.css<%= v %>" as="style"/>
    <link rel="stylesheet" href="/css/17.0000/dtm.css<%= v %>" />
<% } %>
