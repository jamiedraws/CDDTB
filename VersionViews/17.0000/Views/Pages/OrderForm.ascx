                ...
                <div class="form__group form__group-section">
                    ...
                    <div class="form__span-item form form--frame promoCode">
                        <div class="form__fieldset">
                            ...
                            <div class="form__frame">
                                <div class="promo promo__block" id="promo">
                                    <label class="promo__inline promo__name" for="promoCode">
                                        <strong>PROMO CODE:</strong>
                                    </label>
                                    <!-- // Promo Text Field -->
                                    <div class="promo__inline promo__field form__field-label">
                                        <input type="text" class="dtm__restyle form__field cartParam" name="promoCode" id="promoCode">
                                    </div>

                                    <!-- // Promo Button -->
                                    <div class="promo__inline">
                                        <input type="button" class="button confirm-button ddlPromoButton u-vw--100" id="promoCodeButton" value="Apply Code" onclick="_firstRun = false; handleCartChange();">
                                    </div>
                                    <!-- // Promo Validation Message -->
                                    <div class="promo promo__message  center-text top-margin">
       		                                <div class="success-message-container container bg--white u-vw--100 no-margin hide">
                                                    <p class="message__in column-block no-margin">Thank you! Your promo code was applied.</p>
        	                                </div>
                                            <div class="error-message-container container bg--red u-vw--100 no-margin hide">
                                                    <i class="icon-cross"></i> <p class="message__in column-block no-margin" id="errorMessage">Please enter a valid promo code.</p>
                                            </div>
                                     </div>
                                     <style>
                                         .hide {
                    ...
                    <div class="form__span-item bg bg--shade form form--frame">
                        <div class="form__fieldset">
                            <h2 class="form__title colorStep">STEP 4: Select your color</h2>
                            <div class="form__frame">
