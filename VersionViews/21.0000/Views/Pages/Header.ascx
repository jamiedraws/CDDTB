        ...
        <div class="promo-banner">
            <div class="view__in section__in">
                <div class="promo-banner__text">
                    Save up to <b>20% OFF</b> with code: JAN20
                    <button type="button" data-modal-dialog-id="disclaimer-container" data-modal-dialog-actor="open" class="promo-banner__link" aria-haspopup="true">See details</button>
                </div>
            </div>
        </div>
        <% } %>
...
<template data-modal-dialog-template>
    <section id="disclaimer-container" aria-labelledby="disclaimer-title" data-modal-dialog-title="Disclaimer for Promotion" data-modal-dialog-container class="view content section">
        <div id="disclaimer" class="view__anchor"></div>
        <div class="view__in content__text section__in">
            <h2 id="disclaimer-title" class="content__title">OFFER DETAILS</h2>
            <p>*Offer valid through January 15th, 2023 (11:59pm EST) while supplies last. Spend $24 and use code JAN10 to save 10%, spend $50 and use code JAN15 to save 15%, spend $75 and use code JAN20 to save 20% on your order. Valid on first payment of subscriptions, standard pricing resumes on second shipment. Cannot be combined with other offers. Free shipping. Can be redeemed at GetToppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>