...
<section class="upsell-card upsell-card--showcase">
    <div class="upsell-card__group">
        <% 
            var productBUNDLE = products.FirstOrDefault(p => string.Equals(p.ProductCode, "BUNDLE", StringComparison.InvariantCultureIgnoreCase));
        %>

        <div class="upsell-card__img c-brand__img">
            <div class="c-brand__upsell-img" style="--arp:350/450;">
                <img src="/images/upsells/BUNDLE.png" alt="Toppik Bundle">
            </div>
        </div>

        <div class="upsell-card__copy c-brand--upsell">
            <h2 class="c-brand__headline">Buy the Bundle and Save 31%</h2>

            <div class="c-brand__txt">
                <p>Get the look of fuller, thicker hair with this Toppik product bundle. Whether you're looking for hair thickening products or products to give hair volume, Toppik offers a full line of thinning hair styling solutions. Purchase the bundle for only $49.99 plus free shipping, a savings of <strong>31% off</strong> retail!</p>

                <h3>Includes:</h3>
                <ul>
                    <li>Toppik Spray Applicator</li>
                    <li>Toppik Hair Fattener (Full Size - 3.2 oz)</li>
                    <li>Toppik FiberHold Spray (Full Size - 4 fl oz)</li>
                    <li>Toppik Shampoo & Conditioner</li>
                </ul>

                <p><strong>To purchase, select your quantity and click ADD TO ORDER!</strong></p>
            </div>
            <%
                Html.RenderPartial("UpsellActionCard", productBUNDLE);
            %>
        </div>
    </div>
</section>
