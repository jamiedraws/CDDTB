			...
			<div class="content__video">
				<div class="view media-player">
					...
					<div class="media-player__player">
						<div class="media-player__video contain contain--video" data-media-player-src-iframe="https://player.vimeo.com/video/<%= firstVideo.Id %>">
							<iframe src="https://player.vimeo.com/video/<%= firstVideo.Id %>?autopause=0" frameborder="0" allow="fullscreen" allowfullscreen title="Commercial"></iframe>
						</div>
						<%
