    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Black Friday <b>Save up to 25% off</b> with code: BF25 
                <button type="button" data-modal-dialog-id="blackfriday-disclaimer-container" data-modal-dialog-actor="open" class="promo-banner__link" aria-haspopup="true">See details</button>
            </div>
        </div>
    </div>
    <% } %>
...
<template data-modal-dialog-template>
    <section id="blackfriday-disclaimer-container" aria-labelledby="blackfriday-disclaimer-title" data-modal-dialog-title="Disclaimer for BESTDAY Promotion" data-modal-dialog-container class="view content section">
        <div id="blackfriday-disclaimer" class="view__anchor"></div>
        <div class="view__in content__text section__in">
            <h2 id="blackfriday-disclaimer-title" class="content__title">Disclaimer</h2>
            <p>*Offer valid through November 27, 2022 (11:59pm EST) while supplies last. Spend $24 and use code BF15 to save 15%, spend $50 and use code BF20 to save 20%, spend $75 and use code BF25 to save 25% on your order. Valid on first payment of subscriptions, standard pricing resumes on second shipment. Cannot be combined with other offers. Free shipping. Can be redeemed at GetToppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>