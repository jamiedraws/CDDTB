...
<link rel="preload" href="/css/Site18/shell.css" as="style">
<link rel="stylesheet" href="/css/Site18/shell.css">
...
<% if (DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/Site18/page.css" as="style">
    <link rel="stylesheet" href="/css/Site18/page.css">  

    <% if (DtmContext.PageCode == "Index") { %>
        <link rel="preload" href="/css/Site18/index.css" as="style">
        <link rel="stylesheet" href="/css/Site18/index.css">
    <% } %>


    <% if (DtmContext.PageCode == "How-To-Use") { %>
        <link rel="preload" href="/css/Site18/how-to-use.css" as="style">
        <link rel="stylesheet" href="/css/Site18/how-to-use.css">
    <% } %>

    <% if (DtmContext.PageCode == "FAQ") { %>
        <link rel="preload" href="/css/Site18/faq.css" as="style">
        <link rel="stylesheet" href="/css/Site18/faq.css">
    <% } %>

    <script defer src="/js/Site18/app.es5.js"></script>
...
<% if (!DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/Site18/dtm.css" as="style"/>
    <link rel="stylesheet" href="/css/Site18/dtm.css" />
<% } %>
