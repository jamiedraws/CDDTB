...
<main aria-labelledby="main-title" class="view">
	...
	<div class="slide slide--carousel slide--hero">
		<div class="slide__into" tabindex="0" id="hero-carousel">
			<div id="feature-banner-1" class="slide__item blackfriday-banner">
				<picture class="blackfriday-banner__background">
					<img src="/images/Site18/blackfriday/bkg.jpg" alt="">
				</picture>
				<div class="view__in blackfriday-banner__grid section__contain">
					<div class="blackfriday-banner__header">
						<div class="blackfriday-banner__standfirst">It's that time of year!</div>
						<img src="/images/Site18/blackfriday/sale-title.svg" alt="Vip-Only Sale" width="355" height="137">
					</div>
					<div class="blackfriday-banner__save">
						<img src="/images/Site18/blackfriday/save15.svg" alt="Spend $24 Save 15% with discount code BF15" width="170" height="170">
						<img src="/images/Site18/blackfriday/save20.svg" alt="Spend $50 Save 20% with discount code BF20" width="170" height="170">
						<img src="/images/Site18/blackfriday/save25.svg" alt="Spend $75 Save 25% with discount code BF25" width="170" height="170">
					</div>
					<picture class="blackfriday-banner__image">
						<img src="/images/Site18/blackfriday/products.png" alt="Assortment of different Toppik products" width="613" height="420">
					</picture>
				</div>
			</div>
			<div id="feature-banner-2" class="slide__item hero">
		...
		<nav class="slide__thumbnails">
            <a href="#feature-banner-1" class="slide__thumbnail" data-slide-index="0">01</a>
            <a href="#feature-banner-2" class="slide__thumbnail" data-slide-index="1">02</a>
        </nav>
	</div>
</main>
