<%@ Page Language="C#" MasterPageFile="~/VersionViews/16.0000/Views/Layouts/InternalLayout.master" Inherits="System.Web.Mvc.ViewPage<OrderPageViewData>" %>
...
<main aria-labelledby="main-title" class="view hero">
	...
	<div class="view__in section__in hero__in hero--desktop__in">
		<div class="hero__text hero--desktop__text">
			<h1 class="hero__standfirst hero--desktop__standfirst">#1 Hair Filling Solution</h1>
			<h2 class="hero__title hero--desktop__title">CONCEALS. ENHANCES. PERFECTS.</h2>
			<p class="hero__info hero--desktop__info">Whether you're looking to conceal your roots, enhance your
...
<section aria-labelledby="media-title" class="view section main-offer">
	...
	<div class="view__in section__in">
		...
		<div class="main-offer__group">
			<div class="main-offer__price-payment-order main-offer--desktop__price-payment-order">
			...
			<div class="main-offer__info main-offer--desktop__info">
			...
			<div class="main-offer__info main-offer--mobile__info">
					<div class="sr main-offer__price main-offer--mobile__price">
						<div class="sr__text">Now Only $24.95</div>
							<div class="offer" aria-hidden="true" role="presentation">
							<span class="offer__standfirst">NOW ONLY</span>
							<div class="offer__group">
				...
				<div class="main-offer__shipping main-offer--mobile__shipping">
					<b>FREE</b>
					<b>SHIPPING!</b> with subscription
				</div>
			</div>
			
			<div class="main-offer__mbg main-offer--mobile__mbg">
...
<section class="hero__in hero--mobile__in">
	<h2 class="hero__title hero--mobile__title">CONCEALS. ENHANCES. PERFECTS.</h2>
			<p class="hero__info hero--mobile__info">Whether you're looking to conceal your roots, enhance your
			style or perfect your hairline, Toppik Hair Building Fibers are
			the perfect finishing touch and are available in 9 shades for
			all hair types and textures.</p>
</section>
