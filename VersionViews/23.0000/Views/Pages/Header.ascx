    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Receive a <b>FREE FiberHold Spray</b> using code SB2023 <em>while supplies last</em>
...
<template data-modal-dialog-template>
    <section id="promo-disclaimer-container" aria-labelledby="promo-disclaimer-title" data-modal-dialog-title="Disclaimer for free spray Promotion" data-modal-dialog-container class="view content section">
        ...
        <div class="view__in content__text section__in">
            ...
            <p>*Offer valid through March 10th (11:59pm EST) while supplies last. Receive a free FiberHold Spray with your order, using discount code SB2023 at checkout. FiberHold Spray will automatically arrive with your order. Cannot be combined with other offers. Free shipping. Can be redeemed at Toppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>