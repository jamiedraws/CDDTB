    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Sign up for subscription and <b>save 15%</b> + free shipping. Use code SHIP15.
...
<template data-modal-dialog-template>
    <section id="promo-disclaimer-container" aria-labelledby="promo-disclaimer-title" data-modal-dialog-title="Disclaimer for Promotion" data-modal-dialog-container class="view content section">
        ...
        <div class="view__in content__text section__in">
            ...
            <p>*Offer valid through February 20th, 2023 (11:59pm EST) while supplies last. Sign up for subscription, and use code SHIP15 to save 15% on your subscription order Valid on first payment of subscriptions, standard pricing resumes on second shipment. Cannot be combined with other offers. Offer only valid on GetToppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>