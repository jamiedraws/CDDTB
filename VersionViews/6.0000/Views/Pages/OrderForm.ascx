...
<div class="c-brand--form load-item__progress">
    ...
    <div class="form__group">
        ...
        <!-- // Promo Code -->
        <style>
          .dtm .dtm__in .promo__block {
              margin: 0;
          }
        </style>
        <div class="form__row steps c-brand--form__fieldset" id="promoField">
          ...
          <div class="promo" id="promo">
              <div class="promo promo__block">
                  <label class="promo__inline promo__name" for="promoCode">
                      <strong>PROMO CODE:</strong>
                  </label>
                  <!-- // Promo Text Field -->
                  <div class="promo__inline promo__field">
                      <input type="text" class="ddlPromo u-vw--100 cartParam" name="promoCode" id="promoCode">
                  </div>

                  <!-- // Promo Button -->
                  <div class="promo__inline">
                      <input type="button" class="confirm-button ddlPromoButton u-vw--100" id="promoCodeButton" value="Apply Code">
                  </div>
              </div>
              <!-- // Promo Validation Message -->
              <div class="promo promo__block">
                  <div class="promo__block success-message-container hide center-text top-margin">
                      <i class="icon-checkmark"></i> <p class="message__in column-block no-margin">Thank you! Your promo code was applied.</p>
                  </div>
                  <div class="promo__block error-message-container hide center-text top-margin">
