...
<div class="c-brand--form">
    ...
    <section id="product-set" class="hide copy popup">
        <div class="popup__group">
            <div class="popup__item popup__item--full">
                <picture class="popup__img" data-src-img="/images/14.0000/products/fibers-12g.jpg" data-attr='{ "alt" : "Hair Building Fibers (12g)" }'>
                </picture>
                <h3 class="popup__title">HAIR BUILDING FIBERS (12g) - Available in 9 colors!</h3>
            ...
            <div class="popup__label">2 FREE GIFTS</div>
            <hr>
            <div class="popup__item">
                <picture class="popup__img" data-src-img="/images/14.0000/products/duo-kit.jpg" data-attr='{ "alt" : "Hair Perfecting Duo Kit" }'>
                </picture>
                <h3 class="popup__title">Hair Perfecting Duo Kit</h3>
                <p class="popup__desc">This essential duo contains the tools you need for a flawless Hair Fibers application every time, at a 20% savings. Create the look of fuller-looking, thicker hair by using these two must-have tools together with Hair Fibers.</p>
            </div>
        </div>
    </section>
    ...
    <link rel="stylesheet" href="/css/14.0000/form.css">
    ...
    <div class="form__group">
        ...
        <div class="form__row">
            ...
            <div class="c-brand--form__fieldset">
                ...
                <div class="options">
                    ...
                    <label class="option"  for="subscriptionStep1" id="subscriptionOffers">
                        <div class="option__input">
                            <input type="checkbox" id="subscriptionStep1" data-eflex="draw" checked="checked">
                        </div>
                        <div class="option__text">
                            ...
                            <div class="option__offer">
                                <span>Price: </span>
                                <span class="offer__strike">$45.00</span> 
                                <span class="offer__price">$24.95</span> 
                            </div>
                            <div class="offer__savings option__shipping">+ FREE SHIPPING!</div>
                        </div>
                        <figure class="option__image">
                            <picture class="option__set-image" data-src-img="/images/14.0000/products/toppik-set.png" data-tag='{ "img" : [{ "src" : "/images/14.0000/products/toppik-set.png", "alt" : "Hair Building Fibers (12g) plus a FREE Hair Perfecting Duo Kit. A $20 value." }]}'>
                            </picture>
                    ...
                    <label for="oneTimeOption" class="option option--single" id="singleOffers">
                        <div class="option__input">
                            <input type="radio" id="oneTimeOption" name="offerOption" value="1" data-eflex="draw" onclick="assembleProductCode()"> 
                        </div>
                        <div class="option__text">
                        ...
                        <figure class="option__image">
                            <picture class="option__single-image" data-src-img="/images/14.0000/products/fibers-12g.png" data-attr='{ "alt" : "Hair Building Fibers (12g)" }'>
                            </picture>
                            <figcaption>
                                One time purchase
                            </figcaption>
        ...
        <div class="form__row subscriptionOptions">
            <div class="c-brand--form__fieldset">
                <div class="FormHeadlineL c-brand--form__headline c-brand--form__legend"><strong>STEP 2:</strong> Select Your Subscription type</div>
                <div class="options--subscription">
                    <label class="option" for="subscriptionOption30">
                        <span class="option__input-text">
                            <span class="option__input">
                                <input type="radio" id="subscriptionOption30" name="offerOption" value="30" data-eflex="draw" onclick="assembleProductCode()" checked="checked">
                            </span>
                            <span class="option__text">Ship Every 30 Days</span>
                        </span>
                    </label>
                    <label class="option" for="subscriptionOption60">
                        <span class="option__input-text">
                            <span class="option__input">
                                <input type="radio" id="subscriptionOption60" name="offerOption" value="60" data-eflex="draw" onclick="assembleProductCode()">
                            </span>
                            <span class="option__text">Ship Every 60 Days</span>
                        </span>
                    </label>
                </div>
            </div>
        ...
        <div class="form__row">
            <div class="c-brand--form__fieldset">
                <div class="FormHeadlineL c-brand--form__headline c-brand--form__legend"><label class="colorStep"><strong>STEP 3:</strong></label> Select Your Color</div>
                <%= Html.Partial("Shades", Model, new ViewDataDictionary { { "productType", "step2Shades" } }) %>
            </div>
            <input id="ActionCode0" name="ActionCode0" type="hidden" value="SHIP">
            <input id="ActionQuantity0" name="ActionQuantity0" type="hidden" value="0">
            <input id="ActionCode1" name="ActionCode1" type="hidden" value="TBLKS30">
            <input id="ActionQuantity1" name="ActionQuantity1" type="hidden" value="0">
        </div>
                    ...
                    <div class="view__scroll">
                        ...
                        <fieldset id="paymentForm" class="form__border">
                            ...
                            <div class="c-brand--form__legend u-vw--100">
                                <h3 class="c-brand--form__headline"><strong>STEP 5:</strong> Select Your Payment Method
                                </h3>
                            </div>
                            ...
                            <div class="form__border">
                                ...
                                <div class="c-brand--form__legend u-vw--100">
                                    <h3 class="c-brand--form__headline">
                                        <strong>STEP 6:</strong> Enter Your Billing Information
                                </h3>
                                </div>
