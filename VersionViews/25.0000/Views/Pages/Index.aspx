<%@ Page Language="C#" MasterPageFile="~/VersionViews/25.0000/Views/Layouts/InternalLayout.master" Inherits="System.Web.Mvc.ViewPage<OrderPageViewData>" %>
			...
			<div class="content__video">
				<div class="view media-player">
					...
					<div class="media-player__player">
						<div data-media-player-src-iframe="https://player.vimeo.com/video/<%= firstVideo.Id %>?autopause=0" class="media__video contain contain--video bg__picture">
							<iframe src="https://player.vimeo.com/video/<%= firstVideo.Id %>?autopause=0" frameborder="0" allow="fullscreen" title="Commercial" allowfullscreen></iframe>
						</div>
						<%
