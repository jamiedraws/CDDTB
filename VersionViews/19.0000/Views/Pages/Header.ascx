    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Cyber Monday <b>30% off</b> use code: FLASH30 
...
<template data-modal-dialog-template>
    <section id="cybermonday-disclaimer-container" aria-labelledby="cybermonday-disclaimer-title" data-modal-dialog-title="Disclaimer for BESTDAY Promotion" data-modal-dialog-container class="view content section">
        ...
        <div class="view__in content__text section__in">
            <h2 id="cybermonday-disclaimer-title" class="content__title">Disclaimer</h2>
            <p>Offer valid through November 29, 2022 (11:59pm EST) while supplies last. Use code FLASH30 at checkout to save 30% on your order. Valid on first payment of subscription only, standard pricing resumes on second shipment. Cannot be combined with other offers. Offer only valid on GetToppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>