...
<main aria-labelledby="main-title" class="view">
	...
	<div class="slide slide--carousel slide--hero">
		<div class="slide__into" tabindex="0" id="hero-carousel">
			<div id="feature-banner-1" class="slide__item cybermonday-banner">
				<picture class="cybermonday-banner__background">
					<img src="/images/Site19/cybermonday/bkg.jpg" alt="">
				</picture>
				<div class="view__in cybermonday-banner__grid section__contain">
					<div class="cybermonday-banner__header">
						<div class="cybermonday-banner__standfirst">24 Hours Only</div>
					</div>
					<div class="cybermonday-banner__body">
						<div class="cybermonday-banner__callout">30% Off</div>
						<div class="cybermonday-banner__desc">Sitewide, including subscriptions</div>
					</div>
					<div class="cybermonday-banner__footer">
						<div class="cybermonday-banner__action">Use code: <b>FLASH30</b></div>
					</div>
					<picture class="cybermonday-banner__image">
						<img src="/images/Site19/cybermonday/products.png" alt="Assortment of different Toppik products" width="613" height="420">
					</picture>
				</div>
			</div>
