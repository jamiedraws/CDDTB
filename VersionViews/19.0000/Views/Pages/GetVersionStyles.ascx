...
<link rel="preload" href="/css/Site19/shell.css" as="style">
<link rel="stylesheet" href="/css/Site19/shell.css">
...
<% if (DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/Site19/page.css" as="style">
    <link rel="stylesheet" href="/css/Site19/page.css">  

    <% if (DtmContext.PageCode == "Index") { %>
        <link rel="preload" href="/css/Site19/index.css" as="style">
        <link rel="stylesheet" href="/css/Site19/index.css">
    <% } %>


    <% if (DtmContext.PageCode == "How-To-Use") { %>
        <link rel="preload" href="/css/Site19/how-to-use.css" as="style">
        <link rel="stylesheet" href="/css/Site19/how-to-use.css">
    <% } %>

    <% if (DtmContext.PageCode == "FAQ") { %>
        <link rel="preload" href="/css/Site19/faq.css" as="style">
        <link rel="stylesheet" href="/css/Site19/faq.css">
    <% } %>

    <script defer src="/js/Site19/app.es5.js"></script>
...
<% if (!DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/Site19/dtm.css" as="style"/>
    <link rel="stylesheet" href="/css/Site19/dtm.css" />
<% } %>
