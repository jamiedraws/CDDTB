    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                <b>20% OFF</b> Hair Fibers Starter Kit! Use Code: <b>STARTNOW</b>
...
<template data-modal-dialog-template>
    <section id="promo-disclaimer-container" aria-labelledby="promo-disclaimer-title" data-modal-dialog-title="Disclaimer for free spray Promotion" data-modal-dialog-container class="view content section">
        ...
        <div class="view__in content__text section__in">
            ...
            <p>*Offer valid through July 28, 2023 (11:59pm EST) while supplies last. Purchase our Hair Fibers Starter Kit and use code STARTNOW to save 20% on this item. Cannot be combined with other offers. Can be redeemed at GetToppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>