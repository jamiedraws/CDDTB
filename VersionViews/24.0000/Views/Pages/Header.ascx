    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Save 15% on subscriptions using code SPRING15 at checkout
...
<template data-modal-dialog-template>
    <section id="promo-disclaimer-container" aria-labelledby="promo-disclaimer-title" data-modal-dialog-title="Disclaimer for free spray Promotion" data-modal-dialog-container class="view content section">
        ...
        <div class="view__in content__text section__in">
            ...
            <p>*Offer valid through April 16th, 2023 (11:59pm EST) while supplies last. Receive 10% off your order on GetToppik.com using discount code SPRING10. Receive 15% off your first subscription order using discount code SPRING15. Valid on first payment of subscriptions, standard pricing resumes on second shipment. Cannot be combined with other offers. Free shipping. Can be redeemed at Toppik.com. Offer not valid where other Toppik products are sold.</p>
        </div>
    </section>
</template>