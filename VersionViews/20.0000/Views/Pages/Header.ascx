    ...
    <div class="promo-banner">
        <div class="view__in section__in">
            <div class="promo-banner__text">
                Celebrate the Holidays in Style with <b>$10 OFF</b>, use code STYLISH
                <button type="button" data-modal-dialog-id="cybermonday-disclaimer-container" data-modal-dialog-actor="open" class="promo-banner__link" aria-haspopup="true">See details</button>
            </div>
        </div>
    </div>
    <% } %>
...
<template data-modal-dialog-template>
    <section id="cybermonday-disclaimer-container" aria-labelledby="cybermonday-disclaimer-title" data-modal-dialog-title="Disclaimer for BESTDAY Promotion" data-modal-dialog-container class="view content section">
        <div id="cybermonday-disclaimer" class="view__anchor"></div>
        <div class="view__in content__text section__in">
            <h2 id="cybermonday-disclaimer-title" class="content__title">OFFER DETAILS</h2>
            <p>*Offer valid through December 20th, 2022 (11:59pm EST) while supplies last. Use code STYLISH to save $10 on your order. Cannot be combined with other offers.Can only be redeemed at GetToppik.com. Offer not valid where other Toppik products are sold. Standard pricing resumes for all subscription members on second shipment.</p>
        </div>
    </section>
</template>